// Returns the top N scores for the strength:n-back game.
// Uses Supabase service key to fetch scores and masks emails.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const url = `${base}?select=email,best,updated_at&game_id=eq.strength:n-back&best=gt.0&order=best.desc&limit=${limit}`;
